...
protocol NewWishViewControllerProtocol: AnyObject {
    func set(title: String)
}

class NewWishViewController: UIViewController {
    
    var newWishPresenter: NewWishPresenterProtocol?
...
extension NewWishViewController: NewWishViewControllerProtocol {
    func set(title: String) {
...
extension NewWishViewController {
    ...
    func createCreateButton() {
        ...
        createButton.addTarget(nil, action: #selector(createButtonTapped), for: .touchUpInside)
    }
    ...
    func createButtonTapped() {
        ...
        newWishPresenter?.createNew(wish: wish)
        newWishPresenter?.goBack()
    }
    ...
    func createTitleLabel() {
        ...
        titleLabel.font = UIFont(name: "Chalkduster", size: labelSize)
...
extension NewWishViewController: UITextViewDelegate {
